...
agent: Optional[AgentRunner] = None  # Global agent
...
#         raise
# def process_file(file_path: str, file_name: str, file_exist: bool = True) -> Dict:
#     try:        
#         if not file_exist:
...
# def load_data_and_create_index(file_exist, upload_dir: str = UPLOAD_DIR) -> OpenAIAgent:
#     files = [f for f in os.listdir(upload_dir) if os.path.isfile(os.path.join(upload_dir, f))]
#     documents_to_tools_dict = {}

#     for file_name in files:
#         file_path = os.path.join(upload_dir, file_name)
#         result = process_file(file_path, file_name, file_exist= file_exist)
#         if result:
...
#     try:
#         agent = load_data_and_create_index(file_exist=True)
...
def initialize_agent():
    global agent
    agent = build_agent()  # Build and set the global agent
